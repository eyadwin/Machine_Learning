...
#135 separate topics among the articles
#create a list of predictor-response pairs.
# This is a list of two-tuples that contain the most appropriate class label and the raw document text,
...
def obtain_topic_tags():
    ...
    """
    topics = open(
        "reuters21578/all-topics-strings.lc.txt", "r"
    ).readlines()
